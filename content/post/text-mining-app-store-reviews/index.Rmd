...
## Text Mining: What is driving these patterns?
...
```{r}
#grepl('crash|freeze', review_cleaned)
...
wordcloud(words = crash_words$word, freq = crash_words$n, min.freq = 5, max.words=200, random.order=FALSE, rot.per=0.35, col = colfun(8))
```
