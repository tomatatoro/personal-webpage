...
[See GitHub page for underlying code.](https://github.com/tomatatoro/personal-webpage/blob/main/content/post/text-mining-app-store-reviews/index.Rmd)
...
I thought it'd be fitting for my first portfolio project to pay homage to my first job, so I'll be using Apple Store reviews to tell a story about the [Tapas app](https://apps.apple.com/us/app/tapas-comics-and-novels/id578836126).  The goal of this project is to see **what the user experience has been like with the Tapas app.** Specifically, I answer the following questions:
...
ggplot(monthly_count, aes(x = month, y = n, fill = month_flag)) + 
  ...
  labs(title = "58% ofreviews (288 out of 500) are from February - April.",
...
ggplot(avg_rating, aes(x = month, y = avg_rating, fill = month_flag))+
  geom_bar(stat = 'identity') +
  labs(title = 'Average ratings grew through July and falters around August through October.',
